...
Don't panic if in your version you can't see those arrows linking the components in the image below, they can be added manually 
just to indicate the relationship between components.
